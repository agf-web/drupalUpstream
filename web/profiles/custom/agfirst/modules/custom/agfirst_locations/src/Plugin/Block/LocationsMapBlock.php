...
/**
 * @file
 * Contains \Drupal\agfirst_locations\Plugin\Block\LocationsMapBlock.
 */
...
/**
 * Provides a 'LocationsMapBlock' block.
 *
 * @Block(
 *  id = "locations_map_block",
 *  admin_label = @Translation("Locations Map block"),
 * )
 */
class LocationsMapBlock extends BlockBase {
  ...
  public function build() {
    $build = [];
    $block = [
      '#theme' => 'agfirst_locations_map_block',
      '#attributes' => [
        'class' => ['agfirst-locations-map'],
        'id' => 'agfirst-locations-map',
        'data' => $this->getData()
      ],
      '#cache' => [
        'max-age' => 0,
    ...
    $build['agfirst_locations_map_block'] = $block;
    return $build;
  }
